...
const bscTest: ChainContractDetail = {
  erc20: [
    {
      address: common.etherAddress,
      name: 'Binance Token',
      symbol: 'BNB',
      logoURI: './static/token/bnb-token.webp',
      decimals: 18,
      totalSupply: BigNumber.from((10 ** 18).toString()).mul(5 * 10 ** 8),
    },
    {
  ...
  erc20: [
    {
      ...
      logoURI: './static/token/bnb-token.webp',
      decimals: 18,
      totalSupply: BigNumber.from((10 ** 18).toString()).mul(2 * 10 ** 8),
    },
    {
      name: 'Cardano Token',
      symbol: 'ADA',
...
export const contractDetails: { [network: string]: ChainContractDetail } = {
  bscTest,
  bsc,
};

export interface ChainContractDetail {
  erc20: Array<ERC20Detail>;
}
